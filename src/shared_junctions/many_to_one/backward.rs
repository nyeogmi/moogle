...
// == type ==
pub struct Bwd<'a, A: IdLike, B: IdLike> { pub(in crate::shared_junctions) me: &'a ManyToOne<A, B> }
pub struct BwdSet<'a, A: IdLike, B: IdLike> { 
    pub(in crate::shared_junctions) parent: &'a ManyToOne<A, B>, 
...
struct BwdIterator<'a, A: IdLike, B: IdLike> {
    iter: ToManyKeyValueIterator<'a, RawManyToOne<A, B>, B, A>,
}
...
struct BwdKeysIterator<'a, A: IdLike, B: IdLike> {
    iter: ToManyKeysIterator<'a, RawManyToOne<A, B>, B>,
}
